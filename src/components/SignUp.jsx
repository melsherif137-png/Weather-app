      ...
      <div className="relative z-10 w-full max-w-md lg:max-w-lg mb-20">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-400 text-sm mt-2">Sign up to get started</p>
          </div>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-2xl text-sm text-white border border-white/20 outline-none
